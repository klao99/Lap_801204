...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_second, parent, false);
        ...
        viewHolder.txtName.setText("Name :"+values[position]);
        viewHolder.txtVersion.setText("ID :"+numbers[position]);
